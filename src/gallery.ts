...
export const gallery: GalleryItem[] = [
  ...
  {
    id: "backpack-volunteers",
    kind: "photo",
    src: "backpack-volunteers",
    alt: "An HCCS Fire program volunteer and an Alpha Phi Alpha volunteer holding a backpack at a Bee Unique giveaway",
    caption: "Volunteers who turn out to help hand out backpacks.",
    category: "Community",
  },
  {
    id: "backpack-table",
    kind: "photo",
    src: "backpack-table",
    alt: "A gym set up with rows of backpacks ready for a Bee Unique giveaway",
    caption: "Backpacks staged and ready before the doors open.",
    category: "Community",
  },
  {
    id: "free-haircuts",
    kind: "photo",
    src: "free-haircuts",
    alt: "A volunteer barber giving a student a free haircut at a Bee Unique Back2School event",
    caption: "Free haircuts at Back2School day.",
    category: "Community",
  },
  {
    id: "community-day-banner",
    kind: "photo",
    src: "community-day-banner",
    alt: "The Bee Unique banner set up in a school gym on a community giveaway day",
    caption: "Setting up for a community giveaway day.",
    category: "Events",
    focus: "object-[50%_35%]",
  },
  {
    ...
    kind: "photo",
    src: "young-supporter",
    alt: "A young Bee Unique supporter smiling in front of the Bee Unique sign",
    caption: "One of our youngest supporters.",
    category: "Community",
    focus: "object-[50%_30%]",
  },
  {
    id: "hcc-northeast-booth",
    kind: "photo",
    src: "hcc-northeast-booth",
    alt: "The Houston City College Northeast table at a Bee Unique community event",
    caption: "Houston City College Northeast tabling alongside Bee Unique.",
    category: "Events",
  },
];
